                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <input 
                                ...
                                placeholder="Enter TaskManager123!"
                                className="w-full px-14 py-4 rounded-[20px] bg-white/50 border border-white/40 font-bold text-[#0F172A] focus:ring-4 focus:ring-emerald-500/10 focus:border-[#10B981]/30 transition-all placeholder:text-[#94A3B8]/40 text-[13px]"
                            />
                        </div>
                    </div>
